...
class MyLayout(Screen):
    ...
    def callback1(self, msg):
        ...
        if (
            self.warn_carregar is False
            and self.warn_cinto is False
            and self.warn_porta is False
        ):
    ...
    def callback2(self, msg):
        ...
        self.manager.get_screen("reverse_screen").ids.velocidade_label2.text = str(
            velocidade
        )
        self.manager.get_screen("reverse_screen").ids.dist3.text = str(autonomia_perc)
        self.manager.get_screen("close_screen").ids.velocidade_label3.text = str(
            velocidade
        )
        self.manager.get_screen("close_screen").ids.dist4.text = str(autonomia_perc)
        self.manager.get_screen(
            "close_screen"
        ).ids.icon_mudancas1.icon = self.ids.icon_mudancas.icon
    ...
    def show_alert_dialog2(self, dt):
        if not self.dialog2:
            self.dialog2 = MDDialog(
                ...
                buttons=[
                    MDRectangleFlatButton(text="Close", on_release=self.close_dialog2),
                ],
            )
        self.play_sound2()
        self.dialog2.open()
    ...
    def show_alert_dialog3(self, dt):
        if not self.dialog3:
            self.dialog3 = MDDialog(
                ...
                buttons=[
                    MDRectangleFlatButton(text="Close", on_release=self.close_dialog3),
                ],
            )
        self.play_sound2()
        self.dialog3.open()
    ...
    def show_alert_dialog4(self, dt):
        if not self.dialog4:
            self.dialog4 = MDDialog(
                ...
                buttons=[
                    MDRectangleFlatButton(text="Close", on_release=self.close_dialog4),
                ],
            )
        self.play_sound2()
        self.dialog4.open()
    ...
    def show_alert_dialog6(self, dt):
        if not self.dialog6:
            self.dialog6 = MDDialog(
                ...
                buttons=[
                    MDRectangleFlatButton(text="Close", on_release=self.close_dialog6),
                ],
            )
        self.play_sound2()
        self.dialog6.open()
